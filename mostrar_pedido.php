  ...
  <div class="container">
    <div class="columns">
      <div class="column is-11-desktop is-offset-1-desktop">
        <h1 class="has-text-white font-tertiary">Mostrrar pedidos</h1>
      </div>
    </div>
  </div>
...
<section class="section">
  <div class="container">
    <h1 class="title has-text-centered">Listado de Pedidos</h1>
    <table class="table is-striped is-fullwidth">
        ...
        <tbody>
            ...
            // Consulta SQL
            $sql = "SELECT pedido_id, fecha_pedido, total, nombre_producto, cantidad FROM pedidos";
...
<footer class="has-background-dark footer-section" id="footer">
  ...
  <div class="section is-small has-text-centered has-border-top is-border-dark">
    <p class="has-text-light">ShopPoom © <script>var CurrentYear = new Date().getFullYear(); document.write(CurrentYear);</script> papos <a href="themefisher.com">wow</a></p>
  </div>
</footer>
