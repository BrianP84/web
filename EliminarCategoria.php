...
<head>
  <meta charset="utf-8">
  <title>Eliminar Categorías | POOMSTORE</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($categoria_id) {
        ...
        if ($stmt->execute()) {
            $message = "<div class='notification is-primary'>Categoría eliminada exitosamente.</div>";
            $nombre = "";
            $descripcion = "";
            $categoria_id = "";
            $fieldsDisabled = 'disabled-field'; // Deshabilitar campos después de eliminar
        } else {
            $message = "<div class='notification is-danger'>Error al eliminar categoría: " . $stmt->error . "</div>";
        }
  ...
  <div class="container">
    <div class="columns">
      <div class="column is-11-desktop is-offset-1-desktop">
        <h1 class="has-text-white font-tertiary">Eliminar Categorías</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="dropdown is-hoverable">
      ...
      <div class="dropdown-menu" id="dropdown-menu-2" role="menu">
        <div class="dropdown-content">
          ...
          <a href="ActualizarProducto.php" class="dropdown-item">Producto</a>
      ...
      <div class="column is-half">
        ...
        <form action="" method="get" class="box">
          <div class="field">
            ...
            <div class="control">
              <input class="input" type="number" name="id" placeholder="Ingresa el ID de la categoría" value="<?php echo htmlspecialchars($categoria_id); ?>">
            </div>
          </div>
          <div class="field">
            <div class="control">
        ...
        <form action="" method="post" class="box">
          ...
          <div class="field">
            <div class="control">
              <button class="button is-danger" type="submit" <?php echo ($fieldsDisabled ? 'disabled' : ''); ?>>Eliminar Categoría</button>
            </div>
          </div>
        </form>
